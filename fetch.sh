...
download "https://services.gradle.org/distributions/" "gradle-2.6-bin.zip"
...
download "http://gogs.dn.qbox.me/" "gogs_v0.6.5_linux_amd64.zip"
download "http://pkg.jenkins-ci.org/redhat/" "jenkins-1.627-1.1.noarch.rpm"
...
download_mysql_connector
download "http://mirror.centos.org/centos/7.1.1503/os/x86_64/Packages/" "httpd-2.4.6-31.el7.centos.x86_64.rpm"
