...
download "http://pkg.jenkins-ci.org/redhat-stable/" "jenkins-2.32.1-1.1.noarch.rpm"
download "https://sonatype-download.global.ssl.fastly.net/nexus/oss/" "nexus-2.14.2-01-bundle.zip"
...
download "http://dl.fedoraproject.org/pub/epel/7/x86_64/n/" "nodejs-6.9.1-4.el7.x86_64.rpm"
