...
download "http://pkg.jenkins-ci.org/redhat-stable/" "jenkins-2.60.2-1.1.noarch.rpm"
...
download "http://dl.fedoraproject.org/pub/epel/7/x86_64/n/" "nodejs-6.11.1-1.el7.x86_64.rpm"
download "http://dl.fedoraproject.org/pub/epel/7/x86_64/n/" "npm-1.3.6-5.el7.noarch.rpm"
download "http://dl.fedoraproject.org/pub/epel/7/x86_64/n/" "npm-3.10.10-1.6.11.1.1.el7.x86_64.rpm"
