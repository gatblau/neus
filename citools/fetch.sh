...
download "http://dl.fedoraproject.org/pub/epel/7/x86_64/n/" "nodejs-0.10.46-1.el7.x86_64.rpm"
...
download "http://pkg.jenkins-ci.org/redhat-stable/" "jenkins-2.7.4-1.1.noarch.rpm"
